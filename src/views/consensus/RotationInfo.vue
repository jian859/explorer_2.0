<template>
  <div class="rotation-info bg-gray" v-loading="rotationInfoLoading">
    ...
    <div class="info_tabs w1200">
      ...
      <ul class="ul">
        <li class="tabs_infos fl"><p>{{$t('consensus.consensus9')}}<span class="mobile_s">{{rotationInfo.startTime}}-{{rotationInfo.endTime}}</span></p></li>
        ...
        <li class="tabs_infos fl"><p>{{$t('consensus.consensus11')}} <span>{{rotationInfo.producedBlockCount}}</span></p></li>
    ...
    <div class="r_tab w1200">
      <el-col :span="24">
        ...
        <el-table :data="rotationList"  stripe border style="width: 100%; margin:45px 0 100px 0;" v-loading="rotationInfoLoading">
